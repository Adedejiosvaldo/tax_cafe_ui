...
const ToolComponent = memo(({ tools }: ToolCallProps) => (
  <div className="cursor-default rounded-lg border border-primary bg-white px-2 py-1.5 text-xs">
    <p className="font-dmmono uppercase text-primary">{tools.tool_name}</p>
  </div>
))
